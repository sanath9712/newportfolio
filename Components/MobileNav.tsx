  ...
  return (
    <div className={`fixed ${navAnimation} transform transition-all duration-300 top-0 left-0 right-0 bottom-0 z-[1000000] bg-[#09101a]/50 backdrop-blur-lg`}>
      <div className="w-[100vw] h-[100vh] flex flex-col items-center justify-center">
        ...
        <div className="nav-link-mobile" onClick={closeNav}><a href="#hero">ABOUT</a></div>
        ...
        <div className="nav-link-mobile" onClick={closeNav}><a href="#publications">PUBLICATIONS</a></div>
